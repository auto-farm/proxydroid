 ...
 * <p/>
 * Note: The native methods access a package-private java.io.FileDescriptor field to get and set the
 * raw Linux file descriptor. This might break if the implementation of java.io.FileDescriptor is
 * changed.
 */
...
public class Exec {
  ...
  /**
   * Create a subprocess. Differs from java.lang.ProcessBuilder in that a pty is used to communicate
   * with the subprocess.
   * <p/>
   * Callers are responsible for calling Exec.close() on the returned file descriptor.
   *
