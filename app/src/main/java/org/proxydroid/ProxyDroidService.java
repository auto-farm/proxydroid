    ...
    try {
      ...
      if (proxyType.equals("http") && isAuth && isNTLM) {
        Utils.runRootCommand(
            basePath + "proxy.sh " + basePath + " start http 127.0.0.1 8025 false\n"
        ...
        Utils.runRootCommand(
            basePath + "proxy.sh " + basePath + " start" + " " + proxyType + " " + proxyHost
                + " " + proxyPort + " " + auth + " \"" + u + "\" \"" + p + "\"");
      }
