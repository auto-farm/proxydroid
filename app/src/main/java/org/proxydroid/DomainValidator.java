...
public class DomainValidator implements Serializable {
   ...
   * recognized top-level domain. The parsing is case-sensitive.
   *
   ...
   * top-level domain. Leading dots are ignored if present. The search is case-sensitive.
   *
   ...
   * domain. Leading dots are ignored if present. The search is case-sensitive.
   *
